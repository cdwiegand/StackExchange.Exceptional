...
namespace StackExchange.Exceptional.Postgres
{
    /// <summary>
    ///     An <see cref="ErrorStore" /> implementation that uses Postgres as its backing store.
    /// </summary>
    public sealed class PostgresErrorStore : ErrorStore
    {
        /// <summary>
        ...
        /// </summary>
        public PostgresErrorStore(ErrorStoreSettings settings)
            : base(settings)
        {
        ...
        /// </param>
        public PostgresErrorStore(string connectionString, int displayCount = DefaultDisplayCount, int rollupSeconds = DefaultRollupSeconds)
            : base(rollupSeconds)
        {
...
Update Exceptions 
 ...
 Where GUID In @guids", new {guids}) > 0;
        ...
        /// <summary>
        ///     Deletes an error, by setting DeletionDate = current_timestamp in SQL
        /// </summary>
...
Update Exceptions 
 ...
 Where GUID = @guid 
   And DeletionDate Is Null", new {guid, ApplicationName}) > 0;
        ...
        /// <summary>
        ///     Deletes errors, by setting DeletionDate = current_timestamp in SQL
        /// </summary>
...
Delete From Exceptions 
 Where GUID = @guid
   And ApplicationName = @ApplicationName", new {guid, ApplicationName}) > 0;
        ...
        /// <summary>
        ///     Deleted all errors in the log, by setting DeletionDate = current_timestamp in SQL
        /// </summary>
